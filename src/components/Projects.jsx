...
const projects = [
  ...
  },
  {
    ...
    description:
      'A CRUD-based user management application demonstrating full-stack capabilities. Features user creation, editing, deletion, and search — backed by a RESTful API architecture.',
    tags: ['Java', 'Spring Boot', 'React', 'MySQL', 'REST API'],
    color: 'from-emerald-500 to-teal-400',
    features: ['CRUD operations', 'REST API', 'Search & filter', 'Responsive UI'],
  ...
  },
  {
    ...
    description:
      'An interactive circuit control interface built for managing and visualising electrical circuit states. Demonstrates logic-driven UI rendering and real-time state management.',
    tags: ['React', 'JavaScript', 'CSS3', 'State Management'],
    color: 'from-violet-500 to-pink-400',
    features: ['Real-time state', 'Interactive UI', 'Logic circuits', 'Visual feedback'],
